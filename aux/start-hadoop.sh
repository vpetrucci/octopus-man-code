...
#sleep 3
 ...
 /afs/cs.pitt.edu/usr0/vpetrucci/disk2/nutch-test/search/bin/hadoop-daemon.sh start namenode
 /afs/cs.pitt.edu/usr0/vpetrucci/disk2/nutch-test/search/bin/hadoop-daemon.sh start datanode
 /afs/cs.pitt.edu/usr0/vpetrucci/disk2/nutch-test/search/bin/hadoop-daemon.sh start secondarynamenode

 /afs/cs.pitt.edu/usr0/vpetrucci/disk2/nutch-test/search/bin/hadoop-daemon.sh start jobtracker

 /afs/cs.pitt.edu/usr0/vpetrucci/disk2/nutch-test/search/bin/hadoop-daemon.sh start tasktracker
