...
#for c in 5 25 50 75 100 125 150 175 200 225 250;
#for c in 25 50 100 150;
#for c in 15 30 60 120;
#for c in 5 25 50 75 100 125 150;

for type in 'big' 'small';
# for type in 'small';
do
     
for c in 5 10 15 20 25 30 35 40 45 50 55 60 ;
#for c in 2 5 10 15 20 25 30 35 40;
#for c in 1;
 do
...
#    taskset -c 5 /afs/cs.pitt.edu/usr0/vpetrucci/likwid-3.0/likwid-perfctr -o perf-big-$a.txt -t 1s -c 3 -g INSTR_RETIRED_ANY:FIXC0,L2_LINES_IN_THIS_CORE_ALL:PMC0,BUS_TRANS_MEM_THIS_CORE_THIS_A:PMC1 &
    ...
    sleep 10 && taskset -c 5 /afs/cs.pitt.edu/usr0/vpetrucci/likwid-3.0/likwid-perfctr -o perf-big-$a.txt -t 1s -c 2 -g INSTR_RETIRED_ANY:FIXC0,L2_RQSTS_SELF_MESI:PMC0,L2_LINES_IN_THIS_CORE_ALL:PMC1 &
...
#    taskset -c 5 /afs/cs.pitt.edu/usr0/vpetrucci/likwid-3.0/likwid-perfctr -o perf-small-$a.txt -t 1s -c 0 -g INSTR_RETIRED_ANY:FIXC0,L1D_REPL:PMC0,L2_LINES_IN_THIS_CORE_ALL:PMC1 &
    sleep 10 && taskset -c 5 /afs/cs.pitt.edu/usr0/vpetrucci/likwid-3.0/likwid-perfctr -o perf-small-$a.txt -t 1s -c 0 -g INSTR_RETIRED_ANY:FIXC0,L2_RQSTS_SELF_MESI:PMC0,L2_LINES_IN_THIS_CORE_ALL:PMC1 &
  ...
  then
     ...
     # /afs/cs.pitt.edu/usr0/vpetrucci/all-java-to-big-cores-loop-core2.sh > /dev/null & pid1=$!  
...
/afs/cs.pitt.edu/usr0/vpetrucci/move-java-jobs.sh 2
    ...
    #  /afs/cs.pitt.edu/usr0/vpetrucci/all-java-to-small-cores-loop-core0.sh > /dev/null & pid1=$! 
 ...
 # killall all-java-to-big-cores-loop-core2.sh
 # killall all-java-to-small-cores-loop-core0.sh
